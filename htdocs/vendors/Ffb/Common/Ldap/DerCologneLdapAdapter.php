...
/**
 * This adapter considers the special features of the LDAP of DER Touristik Köln.
 *
 * Users of DER Touristik Köln are stored in the LDAP of the REWE Group!
 *
 * Quirks:
 ...
 * @author marcus.gnass
 */
class DerCologneLdapAdapter extends DefaultLdapAdapter {
    ...
    public function getOuSearchFilter($search) {
        ...
        self::DBG && error_log("== DerCologneLdapAdapter::getOuSearchFilter($search)");
    ...
    public function getOuAttributes() {
        ...
        self::DBG && error_log("== DerCologneLdapAdapter::getOuAttributes()");
    ...
    public function getOuData(array $item) {
        ...
        self::DBG && error_log("== DerCologneLdapAdapter::getOuData(array \$item)");
    ...
    public function getGroupSearchFilter($search) {
        ...
        self::DBG && error_log("== DerCologneLdapAdapter::getGroupSearchFilter($search)");
    ...
    public function getGroupAttributes() {
        ...
        self::DBG && error_log("== DerCologneLdapAdapter::getGroupAttributes()");
    ...
    public function getGroupData(array $item) {
        ...
        self::DBG && error_log("== DerCologneLdapAdapter::getGroupData(array \$item)");
    ...
    public function getUserSearchFilter($search) {
        ...
        self::DBG && error_log("== DerCologneLdapAdapter::getUserSearchFilter($search)");
    ...
    public function getUserByDnFilter() {
        ...
        self::DBG && error_log("== DerCologneLdapAdapter::getUserByDnFilter()");
    ...
    public function getUserByUsernameFilter($username) {
        ...
        self::DBG && error_log("== DerCologneLdapAdapter::getUserByUsernameFilter($username)");
    ...
    public function getUserByOuFilter($ouDn) {
        ...
        self::DBG && error_log("== DerCologneLdapAdapter::getUserByOuFilter($ouDn)");
    ...
    public function getUserByGroupFilter($groupDn) {
        ...
        self::DBG && error_log("== DerCologneLdapAdapter::getUserByGroupFilter($groupDn)");
    ...
    public function getUserByManagedOuFilter($ouDn) {
        ...
        self::DBG && error_log("== DerCologneLdapAdapter::getUserByManagedOuFilter($ouDn)");
    ...
    public function getUserAttributes() {
        ...
        self::DBG && error_log("== DerCologneLdapAdapter::getUserAttributes()");
    ...
    public function getUserData(array $item) {
        ...
        self::DBG && error_log("== DerCologneLdapAdapter::getUserData(array \$item)");
