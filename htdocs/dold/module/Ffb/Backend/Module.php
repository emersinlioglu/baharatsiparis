...
class Module extends CommonModule {
    ...
    public function getServiceConfig() {
        ...
        return array(
            'factories' => array(
                'Ffb\Backend\Service\UploadService' => function(ServiceManager $sm) {
                    return new \Ffb\Backend\Service\UploadService($sm);
                },
                'Ffb\Backend\Service\MailService' => function(ServiceManager $sm) {
                    return new \Ffb\Backend\Service\MailService($sm);
                },
                'Ffb\Backend\Service\ProductService' => function(ServiceManager $sm) {
                    return new \Ffb\Backend\Service\ProductService($sm);
                },
