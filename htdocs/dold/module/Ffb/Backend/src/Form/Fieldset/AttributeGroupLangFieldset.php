 ...
 */
class AttributeGroupLangFieldset extends AbstractBackendFieldset {
     ...
     */
    public function __construct($name = 'attribute-group-lang', $options = array(), \Doctrine\ORM\EntityManager $em = null) {
        ...
        $this->setObject(new Entity\AttributeGroupLangEntity());
        $this->setAttribute('class', 'fieldset-default fieldset-attribute-group-lang');
        $this->_setElements();
    }
    ...
    protected function _setElements() {
        ...
        $this->add(array(
            ...
            'type' => 'Text',
            'options' => array(
                'label' => 'LBL_ATTRIBUTE_GROUP_NAME',
