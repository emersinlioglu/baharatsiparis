 ...
 */
class UploadController extends AbstractFrontendController {
    ...
    private function _getUploadService(Entity\UserEntity $me) {
        ...
        $service = $this->getServiceLocator()->get('Ffb\Frontend\Service\UploadService');
    ...
    public function uploadAction() {
        ...
        try {
            ...
            // perform file upload via service
            /* @var $service \Ffb\Frontend\Service\UploadService */
            $service = $this->_getUploadService($this->auth->getIdentity());
