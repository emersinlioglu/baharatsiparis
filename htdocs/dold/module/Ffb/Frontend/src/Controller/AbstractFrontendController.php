 ...
 */
abstract class AbstractFrontendController extends Mvc\Controller\AbstractActionController {
...
//            }
    ...
    public function checkAccess(Entity\UserEntity $user, $area, $function = null, Model\ViewModel $view = null) {
        ...
        return true;
        $userModel = new \Ffb\Frontend\Model\UserModel($this->serviceLocator);
...
//
//            // get user model
//            /*$userModel = new \Ffb\Frontend\Model\UserModel($this->getServiceLocator());
//
