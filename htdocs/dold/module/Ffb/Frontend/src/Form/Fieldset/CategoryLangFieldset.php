 ...
 */
class CategoryLangFieldset extends AbstractBackendFieldset {
     ...
     */
    public function __construct($name = 'category-lang', $options = array(), \Doctrine\ORM\EntityManager $em = null) {
        ...
        $this->setObject(new Entity\CategoryLangEntity());
        $this->setAttribute('class', 'fieldset-default fieldset-category-lang');
        $this->_setElements();
    }
