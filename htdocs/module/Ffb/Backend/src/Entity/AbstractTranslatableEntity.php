 ...
 */
abstract class AbstractTranslatableEntity extends \Ffb\Common\Entity\AbstractBaseEntity {
    ...
    public function getCurrentTranslation($locale = null) {
        ...
        foreach ($this->getTranslations() as $translation) {
            if (is_numeric($locale) && $locale === $translation->getLang()->getId()) {
                return $translation;
            } else if (strtolower($locale) === strtolower($translation->getLang()->getIso())) {
                return $translation;
            }
        }
